              ...
              >
                ...
                >
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Link
                      href="/search-map"
                      className="absolute right-2 top-2 bottom-2 px-6 bg-hospital-primary text-white rounded-lg font-medium hover:bg-hospital-primary/90 transition-all flex items-center justify-center shadow-lg hover:shadow-xl"
                    >
                      검색
                    </Link>
                  </motion.div>
